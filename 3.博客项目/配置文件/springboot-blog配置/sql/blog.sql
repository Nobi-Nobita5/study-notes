...
-- ----------------------------
INSERT INTO `tb_article` VALUES (34, 1, 12, 'http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/articles/1560226369688838145.png', '2022-08-18', '测试!!![RC.jfif](http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/articles/1560226120043864065.jfif)', '2022-08-18 19:12:56', '2022-08-18 19:25:31', 0, 0, 0);
...
INSERT INTO `tb_article_tag` VALUES (276, 34, 18);
...
CREATE TABLE `tb_chat_record`  (
  ...
  `content` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '聊天内容',
  `ip_addr` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ip地址',
...
-- ----------------------------
INSERT INTO `tb_chat_record` VALUES (1, 2, '罐头王者', 'https://www.static.talkxj.com/avatar/user.png', '11', '未知ip', '', 3, '2022-08-18 21:52:56');
INSERT INTO `tb_chat_record` VALUES (2, NULL, '未知ip', 'https://gravatar.loli.net/avatar/d41d8cd98f00b204e9800998ecf8427e?d=mp&v=1.4.14', '11', '未知ip', '', 3, '2022-08-18 21:54:51');
INSERT INTO `tb_chat_record` VALUES (3, 2, '罐头王者', 'hangzhou.aliyuncs.com/config/user.png', '11', '未知ip', '', 3, '2022-08-18 21:55:29');
INSERT INTO `tb_chat_record` VALUES (4, 2, '罐头王者', 'hangzhou.aliyuncs.com/config/user.png', '哈喽啊', '未知ip', '', 3, '2022-08-18 21:55:33');
INSERT INTO `tb_chat_record` VALUES (5, 2, '罐头王者', 'https://www.static.talkxj.com/avatar/user.png', '你是', '未知ip', '', 3, '2022-08-18 21:55:36');
INSERT INTO `tb_chat_record` VALUES (6, 2, '罐头王者', 'https://www.static.talkxj.com/avatar/user.png', '我', '未知ip', '', 3, '2022-08-18 21:55:48');
INSERT INTO `tb_chat_record` VALUES (7, 1, '管理员', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user.png', 'hah ', '未知ip', '', 3, '2022-08-18 22:04:51');
INSERT INTO `tb_chat_record` VALUES (8, 1, '管理员', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user.png', '哈哈', '未知ip', '', 3, '2022-08-18 22:04:57');
INSERT INTO `tb_chat_record` VALUES (9, 2, '罐头王者', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user-default.png', '111', '未知ip', '', 3, '2022-08-18 22:06:07');
INSERT INTO `tb_chat_record` VALUES (10, 1, '管理员', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user.png', 'wth', '未知ip', '', 3, '2022-08-18 22:14:32');
INSERT INTO `tb_chat_record` VALUES (11, 2, '罐头王者', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user-default.png', 'asdas ', '未知ip', '', 3, '2022-08-18 22:19:01');
INSERT INTO `tb_chat_record` VALUES (12, 1, '管理员', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user.png', 'wtf', '未知ip', '', 3, '2022-08-18 22:19:10');
...
CREATE TABLE `tb_menu`  (
  ...
  `icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '菜单icon',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `tb_message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3437 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_message` VALUES (3433, '127.0.0.1', '', '游客', 'https://gravatar.loli.net/avatar/d41d8cd98f00b204e9800998ecf8427e?d=mp&v=1.4.14', '测试', 8, '2022-08-18 14:13:37');
INSERT INTO `tb_message` VALUES (3434, '127.0.0.1', '', '用户1560189584900399105', 'https://www.static.talkxj.com/avatar/user.png', '宇宙无敌', 9, '2022-08-18 16:59:38');
INSERT INTO `tb_message` VALUES (3435, '127.0.0.1', '', '罐头王者', 'https://www.static.talkxj.com/avatar/user.png', 'wtf', 8, '2022-08-18 17:01:05');
INSERT INTO `tb_message` VALUES (3436, '127.0.0.1', '', '游客', 'https://gravatar.loli.net/avatar/d41d8cd98f00b204e9800998ecf8427e?d=mp&v=1.4.14', '？？', 8, '2022-08-18 22:39:19');
...
CREATE TABLE `tb_operation_log`  (
  ...
  `ip_addr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作ip',
...
-- ----------------------------
INSERT INTO `tb_operation_log` VALUES (1, '文章模块', '新增或修改', '/admin/articles', 'com.minzheng.blog.controller.ArticleController.saveArticle', '添加或修改文章', '[{\"articleContent\":\"测试\",\"articleCover\":\"http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.comarticles/1560223194030317569.png\",\"articleTitle\":\"2022-08-18\",\"categoryId\":12,\"isDraft\":0,\"isTop\":0,\"tagIdList\":[18]}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-18 19:12:56');
INSERT INTO `tb_operation_log` VALUES (2, '文章模块', '新增或修改', '/admin/articles', 'com.minzheng.blog.controller.ArticleController.saveArticle', '添加或修改文章', '[{\"articleContent\":\"测试\",\"articleCover\":\"http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.comarticles/1560223827038871553.png\",\"articleTitle\":\"2022-08-18\",\"categoryId\":12,\"id\":34,\"isDraft\":0,\"isTop\":0,\"tagIdList\":[18]}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-18 19:15:29');
INSERT INTO `tb_operation_log` VALUES (3, '文章模块', '新增或修改', '/admin/articles', 'com.minzheng.blog.controller.ArticleController.saveArticle', '添加或修改文章', '[{\"articleContent\":\"测试!![2.png](http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.comarticles/1560224210847047681.png)\",\"articleCover\":\"http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.comarticles/1560223827038871553.png\",\"articleTitle\":\"2022-08-18\",\"categoryId\":12,\"id\":34,\"isDraft\":0,\"isTop\":0,\"tagIdList\":[18]}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-18 19:19:51');
INSERT INTO `tb_operation_log` VALUES (4, '文章模块', '新增或修改', '/admin/articles', 'com.minzheng.blog.controller.ArticleController.saveArticle', '添加或修改文章', '[{\"articleContent\":\"测试!!![RC.jfif](http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/articles/1560226120043864065.jfif)\",\"articleCover\":\"http://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/articles/1560226369688838145.png\",\"articleTitle\":\"2022-08-18\",\"categoryId\":12,\"id\":34,\"isDraft\":0,\"isTop\":0,\"tagIdList\":[18]}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-18 19:25:31');
...
CREATE TABLE `tb_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4177 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, 'admin@qq.com', '$2a$10$9yxSNBw/ivM4JYPnFk7OqOY9EbteNIfGVDacnuIxMSZLP8NE0vwZm', 0, '127.0.0.1', '', '2020-06-29 10:48:18', '2022-08-18 22:28:06');
INSERT INTO `tb_user_auth` VALUES (2, 2, '419330259@qq.com', '$2a$10$ihKFmZSt3H/vNNR/jMZf7OVpytVJ0DLt5iD7MM5JYypPCHb7ht8cq', 0, '127.0.0.1', '', '2022-08-18 16:59:19', '2022-08-18 22:18:57');
INSERT INTO `tb_user_auth` VALUES (3, 3, '1397469370@qq.com', '$2a$10$cKq1/tibkmEBtLC/UwiMfOfVoKjuyFli1miLk2BNXakg1mvNmxvkC', 0, '127.0.0.1', '', '2022-08-18 22:07:40', '2022-08-18 22:08:24');
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (1, NULL, '管理员', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user.png', '发表你的第一篇博客吧', 'https://www.talkxj.com', '2020-06-29 10:48:18', '2021-03-20 22:10:33', 0);
INSERT INTO `tb_user_info` VALUES (2, '419330259@qq.com', '罐头王者', 'https://springboot-vue-blog.oss-cn-hangzhou.aliyuncs.com/config/user-default.png', NULL, NULL, '2022-08-18 16:59:19', '2022-08-18 17:00:45', 0);
...
INSERT INTO `tb_user_role` VALUES (219, 2, 2);
INSERT INTO `tb_user_role` VALUES (220, 3, 2);
